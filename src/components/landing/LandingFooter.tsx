  ...
  return (
    <footer className="bg-gradient-to-b from-gray-50 via-white to-gray-50 text-gray-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12 items-start">
          <div>
            <Link href="/custom-jewelry-boxes" className="inline-block">
              <Image
                src={getLogoUrl()}
                alt="Boxypack"
                width={200}
          ...
          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Our products</h3>
            <p className="text-xs sm:text-sm text-gray-600 mb-4">Explore our custom packaging options.</p>
            <nav className="flex flex-col gap-2">
              <Link href="/custom-jewelry-boxes" className="text-sm text-gray-600 hover:text-[#0c6b76] transition-colors">
                Jewelry Boxes
              </Link>
              <Link href="/candle-boxes" className="text-sm text-gray-600 hover:text-[#0c6b76] transition-colors">
                Candle Boxes
              </Link>
              <Link href="/gift-boxes-with-lid" className="text-sm text-gray-600 hover:text-[#0c6b76] transition-colors">
                Gift Boxes with Lid
              </Link>
            </nav>
          </div>
        ...
        <div className="border-t border-gray-200 pt-8 mt-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
              ...
              <a href={`mailto:${companyContactData.infoEmail}`} className="flex items-center gap-2 text-sm text-gray-600 hover:text-[#0c6b76] transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                {companyContactData.infoEmail}
              </a>
